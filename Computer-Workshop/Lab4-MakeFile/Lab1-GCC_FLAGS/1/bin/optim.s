...
.LBB135:
.LBB136:
	.file 2 "/usr/include/c++/7/ostream"
	.loc 2 561 0
	movl	$25, %edx
	leaq	.LC2(%rip), %rsi
	leaq	_ZSt4cout(%rip), %rdi
...
.LBB167:
.LBB168:
	.file 3 "/usr/include/c++/7/bits/basic_ios.h"
	.loc 3 50 0
...
.LBB170:
.LBB171:
	.file 4 "/usr/include/c++/7/bits/locale_facets.h"
	.loc 4 876 0
	movq	%rbx, %rdi
...
.LASF1462:
	.string	"ferror"
.LASF1520:
	.string	"GNU C++14 7.4.0 -mtune=generic -march=x86-64 -ggdb -O1 -std=c++1z -fstack-protector-strong"
.LASF68:
